...
class CarregarDadosBase{
  ...
  loadBaseGame(){
    Data dado = Data();
    dado.perk = loadPerks(1,"Fabrica","Aumenta 3% toda a produção",1,800,3,0);
//Pistolas**********************************************************************
    GunType pistolas = GunType();
      ...
      pistolas.perk =
          loadPerks(pistolas.id,"Categoria de pistolas","Aumenta 5% o valor das armas",1,500,5,0);
...
//Escopetas******************************************************************************
    ...
    escopetas.perk =
        loadPerks(escopetas.id,"Categoria de escopetas","Aumenta 5% o valor das armas",1,5000,5,0);
    escopetas.gun.add(
...
//Subs**************************************************************************
    ...
    subs.perk =
        loadPerks(subs.id,"Categoria de sub metralhadoras","Aumenta em 5% o valor das armas",1,16000,5,0);
    subs.gun.add(
...
//Fuzis*************************************************************************
    ...
    fuzis.perk =
        loadPerks(fuzis.id,"Categoria de fuzis","Aumenta em 5% o valor das armas",1,35000,5,0);
    fuzis.gun.add(
...
//Snipers***********************************************************************
    ...
    snipers.perk =
        loadPerks(snipers.id,"Categoria de snipers","Aumenta em 5% o valor das armas",1,84000,5,0);
    snipers.gun.add(
  ...
  loadGun(int id,String title,int price,String urlImag,bool lock,int gunTypeId){
    ...
    gun.urlImag = urlImag;
    gun.price = price;
    gun.priceToUnlock = price * (700 + _priceIncrement);
    _priceIncrement += 100;
    gun.lock = lock;
